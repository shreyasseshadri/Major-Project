	...
	try:
		while True:
			if(len(allocator.sorted_usage_list[0]) == 3):
				...
				print(
					'Testing Dependent task2Vm by memory.py, compute.py, network.py')
				...
				# print(task_scores)
				allocator.print_task_scores(task_scores)
				sorted_task_names = allocator.create_sorted_task_names(
					task_scores)
				...
				# print(task_scores)
				allocator.print_task_scores(task_scores)
				allocator.dependent_Task2Vm(
					task_scores, allocator.create_sorted_task_names(task_scores))
				# print(allocator.vm_queue)
				allocator.print_queue()
